...
SOURCES = \
	__init__.py \
	field_stats.py field_stats_dialog.py

PLUGINNAME = field_stats

PY_FILES = \
	__init__.py \
	field_stats.py field_stats_dialog.py

UI_FILES = field_stats_dialog_base.ui
...
QGISDIR=C:\Users\sue\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
